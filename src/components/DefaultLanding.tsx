  ...
  return (
    <main className="min-h-screen bg-background text-foreground selection:bg-primary/20">
      ...
      <nav className="sticky top-0 z-50 border-b border-gray-200 bg-background/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight text-gray-900">Adphex</span>
          </div>
      ...
      <section id="examples" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">Made with Adphex</h2>
      ...
      <footer className="border-t border-gray-200 py-12 bg-background">
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-gray-900">Adphex</span>
          </div>
          <p className="text-gray-500 text-sm">© 2024 Adphex. All rights reserved.</p>
        </div>
      </footer>
    </main>
  );
